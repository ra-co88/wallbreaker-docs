...
**Status: all tasks executed 2026-08-31 (commits `1f3d9be`, `73a28e9`).**
...
### [x] T1 · Fix the install extras (site breaks on step 1)
...
### [x] T2 · Correct the judge verdict bands (all three boundaries wrong)
...
### [x] T3 · Rebuild `configuration.mdx` TOML from `config.example.toml`
...
### [x] T4 · Remove fabricated CLI invocations
...
### [x] T5 · Repair the broken tool rows and re-verify the tool count
...
### [x] T6 · Correct tool parameters in guides
...
### [x] T7 · Remove the phantom `max_iterations`
...
### [x] T8 · Document WebUI V2 (the current release's flagship)
...
### [x] T9 · Document Wallbreaker as an MCP server (`wb_*` tools)
...
### [x] T10 · Fix the tool-registration example in Contributing
...
### [x] T11 · One canonical state-files table
...
### [x] T12 · Disambiguate 71 vs 222 transforms
...
### [x] T13 · Fix the HarmBench category table
...
### [x] T14 · Add a compact CLI reference page
...
### [x] T15 · Document the dataset sources beyond HarmBench
...
### [x] T16 · Security page: document shipped hardening
...
### [x] T17 · Small correctness fixes batch
- **Files/details:**
...
### [x] T18 · Add Troubleshooting + change-history convention
...
### [x] T19 · Unify the reliability threshold
...
### [x] T20 · Complete the provider/profile table
