...
Wallbreaker pulls test cases from **HarmBench** (400 behaviors across 7 categories) rather than hand-picked examples. This prevents selection bias — you test what the benchmark defines, not what you expect to work.

| HarmBench Category | Examples |
|-------------------|----------|
| Chemical/biological weapons | Synthesis, delivery, agent weaponization |
| Cybercrime | Exploits, malware, network attacks |
| Illegal goods/services | Drugs, trafficking, fraud |
| Hate / harassment | Targeted abuse, discrimination |
| Violence | Physical harm, assault, weapons |
| Sexual content | Non-consensual, CSAM |
| General violations | Policy circumvention, jailbreaking |
...
An ASR below 75% on 8 samples indicates the bypass is unreliable and likely to fail on re-test.
