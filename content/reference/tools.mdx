...
<Callout type="info">100 tools registered out of the box (108 with the vendored P4RS3LT0NGV3 engine, which adds the 8 `parsel_*` tools below) across 72 modules in `wallbreaker/tools/`. Use `/tools` in the TUI to see them live during a session.</Callout>
